            ...
            if (!isPick) {
                ...
                holder.itemView.setOnCreateContextMenuListener((menu, v, menuInfo) -> {
                    ...
                    if (repoItem == null) {
                        ...
                        MenuItem menuIgnoreUpdate = menu.findItem(R.id.menu_ignore_update);
                        if (menuIgnoreUpdate != null) {
                            menuIgnoreUpdate.setVisible(false);
                        }
                        MenuItem menuAllowUpdate = menu.findItem(R.id.menu_allow_update);
                        if (menuAllowUpdate != null) {
                            menuAllowUpdate.setVisible(false);
                        }
                    } else {
                        ...
                        MenuItem menuIgnoreUpdate = menu.findItem(R.id.menu_ignore_update);
                        if (menuIgnoreUpdate != null) {
                            menuIgnoreUpdate.setVisible(!ignored);
                        }
                        MenuItem menuAllowUpdate = menu.findItem(R.id.menu_allow_update);
                        if (menuAllowUpdate != null) {
                            menuAllowUpdate.setVisible(ignored);
                        }
                    }
